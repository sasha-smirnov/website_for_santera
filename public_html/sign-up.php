...
<header class="header">
    ...
    <form class="form form_login" method="post" action="validation/check.php">
        <h2 class="form__text form__text_login">Регистрация</h2>
        ...
        <input name="name" class="form__field-text form__field-text_login" placeholder="Имя" type="text"
            size="40" required minLength="2" id="name" maxLength="40" onChange="handleUserEmail" />
        <input name="number" class="form__field-text form__field-text_login" placeholder="+7 (___)___-__-__" type="text"
            size="40" required minLength="2" id="number" maxLength="40" onChange="handleUserEmail" />
        <input name="city" class="form__field-text form__field-text_login" placeholder="Город" type="text"
            size="40" required minLength="2" id="city" maxLength="40" onChange="handleUserEmail" />
        ...
        <button type="submit" class="form__save-button form__save-button_login">Зарегистрироваться</button>
        <p class="form__under-button-text">Уже зарегистрированы? <a class="form__under-button-link" href="sign-in.php">Войти</a></p>
    </form>
