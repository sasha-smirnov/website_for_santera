            ...
            <div class="wrapper__content">
                <div class="intro__texts">
                    ...
                    <p class="button_to_catalog">
                        ...
                        <button class="to__catalog">Перейти в каталог</button>
                        </form>
                    </p>
                </div>
                <div class="first__shower__head">
                    <img src="./img/svg/42mainpage.svg" alt="SANTERA" class="shower__header-pic">
                </div>
                <div class="second__shower__head">
                    <img src="./img/svg/17mainpage.svg" alt="SANTERA" class="shower__header-pic">
                </div>
                <div class="third__shower__head">
                    <img src="./img/svg/5mainpage.svg" alt="SANTERA" class="shower__header-pic">
                </div>
            </div>
